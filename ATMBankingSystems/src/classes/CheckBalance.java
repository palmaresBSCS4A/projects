...
public class CheckBalance extends javax.swing.JFrame {
     ...
     * @param m
     */
    public CheckBalance(MainApp mainApp) {
        initComponents();
        setSize(1366, 768);
        ...
        double balance = mainApp.getBalance();
   
        DecimalFormat df = new DecimalFormat("#,###.00");

        balanceTF.setText(df.format(balance));
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(630, 330, 200, 60);

        jLabel4.setFont(new java.awt.Font("Berlin Sans FB", 1, 24)); // NOI18N
        jLabel4.setText("PHP");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(810, 340, 90, 40);

        balanceTF.setEditable(false);
        balanceTF.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 24)); // NOI18N
        ...
        balanceTF.setBounds(800, 330, 300, 60);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/balanceinquiry.png"))); // NOI18N
